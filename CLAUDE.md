...
🏗️ = architecture (read these at session start)  🔴 = gotchas  🟤 = decisions  🔵 = patterns  🟢 = references
...
| 🟢 | TypeScript type safety, runtime validation, and secure coding patterns for web applications | @docs/knowledge/references/TYPESCRIPT_WEB_SECURITY.md | ~2490 |
